:- module('jsonFunctions', [readJSON/2, checaExistencia/2, getObjetoByID/3, atualizaAtributoAluno/3, atualizaAtributoProfessor/3], getObjetoByID/3, addMonitor/3, existeDisciplina/1).
